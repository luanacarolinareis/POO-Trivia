...
class Artes extends Pergunta {
     ...
     */
    protected String[] answers = new String[5];

    /**
     * Lista de respostas curta para a 1.ª e 2.ª pergunta (3 opções)
     */
    ...
    public String[] getEasyAnswers() {
        ...
        this.subAnswers = subAnswers.toArray(new String[0]);
     ...
     */
    public String[] getHardAnswers() { return this.answers; }
